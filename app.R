...
#        plotlyOutput(outputId = "bar_oil")
  ...
  h4("Findings"),
  p("In 1995, the global population was around 5.7 billion people and the average CO2 emissions were around 7.2 metric tons per capita. This means that the total global CO2 emissions in 1995 were around 40.6 billion metric tons.

By 2021, the global population had grown to 7.9 billion people and the average CO2 emissions had increased to 7.6 metric tons per capita. This means that the total global CO2 emissions in 2021 were around 60.0 billion metric tons.

This increase in CO2 emissions is likely due to a number of factors, including population growth, economic growth, and the increased use of fossil fuels. The burning of fossil fuels releases greenhouse gases into the atmosphere, which trap heat and contribute to climate change.

The graph also shows that the rate of increase in CO2 emissions has accelerated in recent years. This is a worrying trend, as it suggests that climate change is happening faster than we thought.")
)
...
Here are some additional findings from the image:

The United States has the highest per capita carbon dioxide emissions in the world, at 15.5 metric tons per capita.
China has the second highest per capita carbon dioxide emissions in the world, at 7.7 metric tons per capita.
India has the third highest per capita carbon dioxide emissions in the world, at 2.1 metric tons per capita.
The global average per capita carbon dioxide emissions are 4.8 metric tons.
These findings suggest that developed countries need to reduce their per capita carbon emissions significantly in order to meet global climate goals.")
  )
)
